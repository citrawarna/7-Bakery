...
<body>
        ...
        <ul class="navbar-nav" id="scrollWeb">
          ...
          <li class="nav-item dropdown">
	        ...
	        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
	          ...
	          <a class="dropdown-item" href="roti-isi.php">Roti Isi</a>
	          <a class="dropdown-item" href="sandwich.php">Sandwich</a>
	          <a class="dropdown-item" href="donat.php">Donat</a>
	          <a class="dropdown-item" href="brownies.php">Brownies</a>
	          <a class="dropdown-item" href="kue-basah.php">Kue Basah</a>
	          <a class="dropdown-item" href="kue-kering.php">Kue Kering</a>
	          <a class="dropdown-item" href="kue-tart.php">Kue Tart</a>
	          <a class="dropdown-item" href="pudding.php">Pudding</a>
	        </div>
	      </li>
          <li class="nav-item">
	...
	<br><br>
     ...
     <div class="container-fluid">
    	<div class="row">
			<img src="../img/page-product.jpg" alt="" class="img-fluid img-header">
			<div class="centered">Sandwich</div>
		</div>
		<br>
		<div class="row">
			<div class="col-lg-8">
				<div id="gallery" style="display:none;">
					<img alt="Preview Image 1"
						 src="images/sandwich/thumbs/1.jpg"
						 data-image="images/sandwich/1.jpg"
						 data-description="Cheese and Onion Sandwich">
					
					<img alt="Preview Image 2"
						 src="images/sandwich/thumbs/2.jpg"
						 data-image="images/sandwich/2.jpg"
						 data-description="Squid Sandwich">

					<img alt="Preview Image 3"
						 src="images/sandwich/thumbs/3.jpg"
						 data-image="images/sandwich/3.jpg"
						 data-description="Camp Fire Sandwich">
						 
					<img alt="Preview Image 4"
						 src="images/sandwich/thumbs/4.jpg"
						 data-image="images/sandwich/4.jpg"
						 data-description="Long Sandwich">

					<img alt="Preview Image 5"
						 src="images/sandwich/thumbs/5.jpg"
						 data-image="images/sandwich/5.jpg"
						 data-description="Beef Sandwich">
					
					<img alt="Preview Image 6"
						 src="images/sandwich/thumbs/6.jpg"
						 data-image="images/sandwich/6.jpg"
						 data-description="Sandwich">

					<img alt="Preview Image 7"
						 src="images/sandwich/thumbs/7.jpg"
						 data-image="images/sandwich/7.jpg"
						 data-description="Vegetarian Sandwich">
			...
			<div class="col-lg-4">
				<h1>Aneka Sandwich 7 Bakery</h1>
				<table class="tbl-roti">
					<tr>
						<td><i class="fa fa-angle-double-right" aria-hidden="true"></i></td>
						<td>Cheese and Onion Sandwich</td>
					</tr>
					<tr>
						<td><i class="fa fa-angle-double-right" aria-hidden="true"></i></td>
						<td>Squid Sandwich</td>
					</tr>
					<tr>
						<td><i class="fa fa-angle-double-right" aria-hidden="true"></i></td>
						<td>Camp Fire Sandwich</td>
					</tr>
					<tr>
						<td><i class="fa fa-angle-double-right" aria-hidden="true"></i></td>
						<td>Long Sandwich</td>
					...
					<tr>
						<td  style="padding:15px;" class="bg-cream" colspan="2"><h2>All Item Start From 5k</h2></td>
					</tr>
				</table>
			</div>
		</div>
		<br>
	 	...
	 	<div class="row bg-cream" style="text-align:center">
	 		...
	 		<div class="col-md-6" style="text-align:left">		
	 			<img src="../img/img-kelebihan.jpeg" alt="Service 2" width="100%" style="border:10px solid white">		
	 		<br><br>
	 		</div>	
	 	</div>
