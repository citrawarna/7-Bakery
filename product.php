...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="centered">Product</div>
		</div>
		...
		<div class="row bg-cream" style="text-align:center; " id="product">
		    ...
		    <div class="image col-lg-3col-sm-3 col-md-3">
		    	<a href="product/kue-basah.php"><img class="img-responsive" src="img/kue-basah.jpg" width="300px" height="300px">
		    		<div class="overlay">
		    			<div class="text"><h2>Kue Basah</h2></div>
		    		</div>
		    	</a>
		    </div>
		    <div class="image col-lg-3col-sm-3 col-md-3">
		    	<a href="product/kue-kering.php"><img class="img-responsive" src="img/kue-kering.jpg" width="300px" height="300px">
		    		<div class="overlay">
		    			<div class="text"><h2>Kue Kering</h2></div>
		    		</div>
		    	</a>
		    </div>
		    <div class="image col-lg-3col-sm-3 col-md-3">
		    	<a href="product/kue-tart.php"><img class="img-responsive" src="img/kue-tart.jpg" width="300px" height="300px">
		    		<div class="overlay">
		    			<div class="text"><h2>Kue Tart</h2></div>
		    		</div>
		    	</a>
		    </div>
		    <div class="image col-lg-3col-sm-3 col-md-3">
		    	<a href="product/pudding.php"><img class="img-responsive" src="img/pudding.jpg" width="300px" height="300px">
		    		<div class="overlay">
		    			<div class="text"><h2>Pudding</h2></div>
		    		</div>
		    	</a>
		    </div>
		    &nbsp;
